...
def ssd_300(image_size,
    ...
    # vgg19_no_pool5 = Sequential()
    # for layer in vgg19.layers[1:-1]:
    #     layer.trainable = False
    #     vgg19_no_pool5.add(layer)

    # vgg19_no_pool5.build()
    # vgg19_no_pool5.summary()
    # feats_extracted = vgg19_no_pool5(x1)
